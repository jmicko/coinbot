...
const exchange = async (dbOrder) => {
  ...
  await sleep(100)
    ...
    .then((result) => {
      cbOrder = result;
      console.log('way up top, cbOrder', cbOrder);
      ...
      console.log('rando cbOrder log', cbOrder);
      // const pendingTrade = authedClient.placeOrder(tradeDetails);
      // console.log('trade details:', tradeDetails, 'pending trade:', pendingTrade);
