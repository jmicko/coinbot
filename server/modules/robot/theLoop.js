...
// todo - get rid of these when sure they are not needed anywhere else
...
const theLoop = async () => {
  ...
  Can eliminate looping through all open orders entirely by only checking buy/sell at a time. 
  ...
  since we only check one at a time. This newer loop means far less data processing, fewer API calls 
  (only 2), and a much less complicated loop */
